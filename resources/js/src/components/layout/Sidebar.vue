                        ...
                        <li class="menu nav-item">
                            ...
                            >
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('elements') }}</span>
                                </div>
                        ...
                        <li class="menu nav-item">
                            <router-link to="/charts" class="nav-link group" @click="toggleMobileMenu">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('charts') }}</span>
                                </div>
                            </router-link>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <router-link to="/widgets" class="nav-link group" @click="toggleMobileMenu">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('widgets') }}</span>
                                </div>
                            </router-link>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <router-link to="/tables" class="nav-link group" @click="toggleMobileMenu">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('tables') }}</span>
                                </div>
                            </router-link>
                        </li>
                        ...
                        <li class="menu nav-item">
                            ...
                            >
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('forms') }}</span>
                                </div>
                        ...
                        <li class="menu nav-item">
                            ...
                            >
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('users') }}</span>
                                </div>
                        ...
                        <li class="menu nav-item">
                            ...
                            >
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black">{{ $t('pages') }}</span>
                                </div>
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'pages'">
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li class="menu nav-item">
                                        <button
                                            type="button"
                                            class="w-full before:bg-gray-300 before:w-[5px] before:h-[5px] before:rounded ltr:before:mr-2 rtl:before:ml-2 hover:bg-gray-100"
