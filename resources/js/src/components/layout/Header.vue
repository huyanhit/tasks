<template>
    <header class="z-40" :class="{ dark: store.semidark && store.menu === 'horizontal' }">
        <div class="shadow-sm">
            <div class="relative bg-white flex w-full items-center px-5 py-2.5">
                <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        ...
                        <span
                            class="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle hidden md:inline transition-all duration-300"
                            >VRISTO</span
                        >
                    </router-link>
                ...
                <div class="ltr:mr-2 rtl:ml-2 hidden sm:block">
                    <ul class="flex items-center space-x-2 rtl:space-x-reverse">
                        <li>
                            <router-link
                                to="/apps/calendar"
                                class="block p-2 rounded-full bg-white-light/40 hover:text-primary hover:bg-white-light/90"
                            >
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                >
                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8">
                            ...
                            <template #content="{ close }">
                                <ul class="!px-2 text-dark grid grid-cols-2 gap-2 font-semibold w-[280px]">
                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="8">
                            ...
                            <template #content="{ close }">
                                <ul class="top-11 !py-0 text-dark w-[300px] sm:w-[375px] text-xs">
                                    <li class="mb-5">
                                    ...
                                    <template v-for="msg in messages" :key="msg.id">
                                        <li>
                                            <div class="flex items-center py-3 px-5">
                                                ...
                                                <span class="px-3">
                                                    <div class="font-semibold text-sm" v-text="msg.title"></div>
                                                    <div v-text="msg.message"></div>
                                                </span>
                                                <span
                                                    class="font-semibold bg-white-dark/20 rounded text-dark/60 px-1 ltr:ml-auto rtl:mr-auto whitespace-pre ltr:mr-2 rtl:ml-2"
                                                    v-text="msg.time"
                                                ></span>
                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8">
                            <button
                                type="button"
                                class="relative block p-2 rounded-full bg-white-light/40 hover:text-primary hover:bg-white-light/90"
                            >
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <template #content="{ close }">
                                <ul class="!py-0 text-dark w-[300px] sm:w-[350px] divide-y">
                                    <li>
                                            ...
                                            <div class="group flex items-center px-4 py-2">
                                                ...
                                                <div class="ltr:pl-3 rtl:pr-3 flex flex-auto">
                                                    <div class="ltr:pr-3 rtl:pl-3">
                                                        ...
                                                        <span class="text-xs block font-normal" v-text="notification.time"></span>
                                                    </div>
                                                    <button
                                                        type="button"
                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8" class="!block">
                            ...
                            <template #content="{ close }">
                                <ul class="text-dark !py-0 w-[230px] font-semibold">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            ...
                                            <div class="ltr:pl-4 rtl:pr-4 truncate">
                                                ...
                                                <a class="text-black/60 hover:text-primary" href="javascript:;"
                                                    >johndoe@gmail.com</a
                                                >
                                            </div>
                                        </div>
            ...
            <!-- horizontal menu -->
            <ul
                class="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] text-black"
            >
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="relative">
                            ...
                            <ul
                                class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark shadow p-0 py-2 hidden"
                            >
                                <li>
